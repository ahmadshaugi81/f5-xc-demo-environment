"""
vuln-bank Slow L7 DDoS Traffic Simulator
==========================================
Simulates a slow HTTP attack against non-authenticated endpoints.

Opens many concurrent connections with a long timeout to exhaust server
worker threads without generating high RPS — making it harder to detect
than a volumetric flood.
...
Run examples:
  locust -f locust-slowddos.py --host=https://vulnbank.yourdomain.com --users 100 --spawn-rate 10
  locust -f locust-slowddos.py --host=https://vulnbank.yourdomain.com --headless --users 100 --spawn-rate 10 --run-time 240h
  locust -f locust-slowddos.py --host=https://vulnbank.yourdomain.com --headless --users 100 --spawn-rate 10
"""
...
# ──────────────────────────────────────────────────────────────
# Slow L7 Attack
# Opens many concurrent connections with a long timeout.
