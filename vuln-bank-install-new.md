...
> ⚠️ If your server has nginx, app-protect, or nginx-plus repos configured, they may cause `apt update` to fail with `400 Bad Request` errors — blocking all package installations. Fix this first before installing anything.
